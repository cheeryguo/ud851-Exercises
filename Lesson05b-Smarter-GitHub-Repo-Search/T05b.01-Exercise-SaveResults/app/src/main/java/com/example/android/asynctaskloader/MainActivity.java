...
public class MainActivity extends AppCompatActivity {
    ...
    private static String qureyURLKey = "QUERY_URL";
    // TODO (2) Create a static final key to store the search's raw JSON
    private static String rawJSONKey = "RAW_JSON";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            mUrlDisplayTextView.setText(savedInstanceState.getString(qureyURLKey));
    ...
    protected void onSaveInstanceState(Bundle outState) {
        //
        outState.putString(rawJSONKey, mSearchResultsTextView.getText().toString());
        outState.putString(qureyURLKey,mUrlDisplayTextView.getText().toString());
    }
